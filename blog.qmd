...
include-in-header:
  text: |
    <style>
      ...
      .hero-banner { background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%); color: white; padding: 60px 40px; margin: -20px -20px 40px -20px; border-radius: 0 0 20px 20px; text-align: center; position: relative; overflow: hidden; }
...
<div class="pitch-container">
  ...
  <div style="display:flex; gap:16px; justify-content:center; flex-wrap:wrap; margin-top:10px; font-size:0.78em; color:#555;">
    ...
    <span><svg width="12" height="12"><circle cx="6" cy="6" r="5" fill="#3d85c8"/></svg> Gyökeres</span>
    <span><svg width="12" height="12"><circle cx="6" cy="6" r="5" fill="#27ae60"/></svg> João Pedro</span>
...
<div class="players-section">
  <div class="scroll-card">
    ...
    <div class="card-info">
      <div class="card-name">⭐ Erling Haaland</div>
      <div class="card-team">Manchester City FC</div>
      <div class="card-stats">
        <div class="card-stat-item"><div class="val">22</div><div class="lbl">Goals</div></div>
        <div class="card-stat-item"><div class="val">21.6%</div><div class="lbl">Conversion</div></div>
        <div class="card-stat-item"><div class="val">100</div><div class="lbl">Clinicality</div></div>
      </div>
    </div>
    <div class="card-bar">
      <div style="font-size:0.72em;color:#999;text-transform:uppercase;letter-spacing:0.04em;">Clinicality Score</div>
      <div class="bar-track"><div class="bar-fill" style="--fill-width:100%"></div></div>
    </div>
  </div>
  <div class="scroll-card">
    <div class="rank" style="color:#3d85c8">#2</div>
    <div class="card-info">
      <div class="card-name">🔥 Igor Thiago</div>
      <div class="card-team">Brentford FC</div>
      <div class="card-stats">
        <div class="card-stat-item"><div class="val">18</div><div class="lbl">Goals</div></div>
        <div class="card-stat-item"><div class="val">26.9%</div><div class="lbl">Conversion</div></div>
        <div class="card-stat-item"><div class="val">88.8</div><div class="lbl">Clinicality</div></div>
      </div>
    </div>
    <div class="card-bar">
      <div style="font-size:0.72em;color:#999;text-transform:uppercase;letter-spacing:0.04em;">Clinicality Score</div>
      <div class="bar-track"><div class="bar-fill" style="--fill-width:88.8%"></div></div>
    </div>
  </div>
  <div class="scroll-card">
    <div class="rank" style="color:#f5a623">#3</div>
    <div class="card-info">
      <div class="card-name">João Pedro</div>
      <div class="card-team">Chelsea FC</div>
      <div class="card-stats">
        <div class="card-stat-item"><div class="val">14</div><div class="lbl">Goals</div></div>
        <div class="card-stat-item"><div class="val">23.0%</div><div class="lbl">Conversion</div></div>
        <div class="card-stat-item"><div class="val">71.1</div><div class="lbl">Clinicality</div></div>
      </div>
    </div>
    <div class="card-bar">
      <div style="font-size:0.72em;color:#999;text-transform:uppercase;letter-spacing:0.04em;">Clinicality Score</div>
      <div class="bar-track"><div class="bar-fill" style="--fill-width:71.1%"></div></div>
    </div>
  </div>
  <div class="scroll-card">
    <div class="rank" style="color:#27ae60">#4</div>
    <div class="card-info">
      <div class="card-name">Viktor Gyökeres</div>
      <div class="card-team">Arsenal FC</div>
      <div class="card-stats">
        <div class="card-stat-item"><div class="val">11</div><div class="lbl">Goals</div></div>
        <div class="card-stat-item"><div class="val">25.6%</div><div class="lbl">Conversion</div></div>
        <div class="card-stat-item"><div class="val">59.3</div><div class="lbl">Clinicality</div></div>
      </div>
    </div>
    <div class="card-bar">
      <div style="font-size:0.72em;color:#999;text-transform:uppercase;letter-spacing:0.04em;">Clinicality Score</div>
      <div class="bar-track"><div class="bar-fill" style="--fill-width:59.3%"></div></div>
    </div>
  </div>
  <div class="scroll-card">
    <div class="rank" style="color:#888">#5</div>
    <div class="card-info">
      <div class="card-name">Danny Welbeck</div>
      <div class="card-team">Brighton & Hove Albion FC</div>
      <div class="card-stats">
        <div class="card-stat-item"><div class="val">10</div><div class="lbl">Goals</div></div>
        <div class="card-stat-item"><div class="val">25.0%</div><div class="lbl">Conversion</div></div>
        <div class="card-stat-item"><div class="val">54.2</div><div class="lbl">Clinicality</div></div>
      </div>
    </div>
    <div class="card-bar">
      <div style="font-size:0.72em;color:#999;text-transform:uppercase;letter-spacing:0.04em;">Clinicality Score</div>
      <div class="bar-track"><div class="bar-fill" style="--fill-width:54.2%"></div></div>
    </div>
  </div>
</div>
```
