...
<div class="hero-banner">
  ...
  <div style="position:relative; z-index:2; width:100%; text-align:center; padding:0 40px 40px 40px;">
    ...
    <div class="meta">Adam Wilkes &nbsp;&middot;&nbsp; 29 April 2026 &nbsp;&middot;&nbsp; BEE2041 Empirical Project</div>
  </div>
...
<div class="chart-container">
  ...
  <div class="chart-caption">Figure 5 - Actual goals (coloured) vs counterfactual goals at median conversion (grey). Green = above-median finisher; Red = below-median finisher. Hover for full stats.</div>
</div>
<div class="insight-box green">
